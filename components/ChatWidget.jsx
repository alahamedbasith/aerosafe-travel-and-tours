    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-24 left-6 z-50 bg-primary hover:bg-primary-dark text-white rounded-full shadow-card-lg w-14 h-14 flex items-center justify-center transition-colors"
        >
